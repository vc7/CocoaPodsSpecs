...
Pod::Spec.new do |s|
  ...
  s.author             = { "vincent" => "vince78718@gmail.com" }
  # s.authors          = { "vincent" => "vince78718@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'vincent', 'other author'
  # s.social_media_url = "http://twitter.com/vincent"
